...
class LineIteratorFeed(
    ...
    // helpers de ventada
    private fun windowEndAbs(): Int = windowStartAbsIndex + windowLength
    private fun needToCover(absIndex: Int): Boolean = absIndex >= windowEndAbs()
    private fun hasSpace(): Boolean = windowLength < maxWindowCapacity
    private fun linesLeft(): Boolean = pendingLine != null || lineIterator.hasNext()
